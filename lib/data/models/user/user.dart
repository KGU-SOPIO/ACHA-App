...
class UserResponse with _$UserResponse {
  ...
  const factory UserResponse.error(
      {@ErrorCodeConverter() required ErrorCode code}) = UserError;

  factory UserResponse.fromJson(Map<String, dynamic> json) =>
      const _UserResponseConverter().fromJson(json);
}

class _UserResponseConverter
    implements JsonConverter<UserResponse, Map<String, dynamic>> {
