...
mixin _$SignInResponse {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(@ResponseCodeConverter() ResponseCode code)
        fetchUserData,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(@ResponseCodeConverter() ResponseCode code)?
        fetchUserData,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>({
    TResult Function(String accessToken, String refreshToken)? success,
    TResult Function(@ResponseCodeConverter() ResponseCode code)? fetchUserData,
...
abstract class _$$FetchUserDataImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({@ResponseCodeConverter() ResponseCode code});
}
...
class _$FetchUserDataImpl implements FetchUserData {
  const _$FetchUserDataImpl(
      {@ResponseCodeConverter() required this.code, final String? $type})
...
abstract class FetchUserData implements SignInResponse {
  const factory FetchUserData(
          {@ResponseCodeConverter() required final ResponseCode code}) =
      _$FetchUserDataImpl;
